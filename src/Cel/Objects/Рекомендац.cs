...
namespace IIS.Cel
{
    ...
    public class Рекомендац : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Cel.ПричинУвольн fПричинУвольн;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Cel.ПричинУвольн.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПричинУвольн"})]
        public virtual IIS.Cel.ПричинУвольн ПричинУвольн
        {
            get
            {
                ...
                IIS.Cel.ПричинУвольн result = this.fПричинУвольн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РекомендацE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РекомендацE", typeof(IIS.Cel.Рекомендац));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРекомендац : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Cel.DetailArrayOfРекомендац members)

        // *** End programmer edit section *** (IIS.Cel.DetailArrayOfРекомендац members)
        ...
        /// </summary>
        public DetailArrayOfРекомендац(IIS.Cel.ПричинУвольн fПричинУвольн) : 
                base(typeof(Рекомендац), ((ICSSoft.STORMNET.DataObject)(fПричинУвольн)))
        {
        }
        
        public IIS.Cel.Рекомендац this[int index]
        {
            get
            {
                return ((IIS.Cel.Рекомендац)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Cel.Рекомендац dataobject)
        {

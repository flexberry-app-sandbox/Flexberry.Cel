...
namespace IIS.Cel
{
    ...
    [View("ПричинУвольнE", new string[] {
            ...
            "Специалист as \'ФИО\'",
            "ОценПричУвольн.НеУдовл as \'Не удовл\'"})]
    ...
    public class ПричинУвольн : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Cel.ОценПричУвольн fОценПричУвольн;
        
        private IIS.Cel.Специалист fСпециалист;
        
        private IIS.Cel.DetailArrayOfРекомендац fРекомендации;
        ...
        [PropertyStorage(new string[] {
                "ОценПричУвольн"})]
        public virtual IIS.Cel.ОценПричУвольн ОценПричУвольн
        {
            get
            {
                ...
                IIS.Cel.ОценПричУвольн result = this.fОценПричУвольн;
        ...
        public virtual IIS.Cel.DetailArrayOfРекомендац Рекомендации
        {
            get
            {
                ...
                {
                    this.fРекомендации = new IIS.Cel.DetailArrayOfРекомендац(this);
                }
                IIS.Cel.DetailArrayOfРекомендац result = this.fРекомендации;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнE", typeof(IIS.Cel.ПричинУвольн));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПричинУвольнL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПричинУвольнL", typeof(IIS.Cel.ПричинУвольн));
                }
            }
        }
    }

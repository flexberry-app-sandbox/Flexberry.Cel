...
namespace IIS.Cel
{
    ...
    public class Анкеты : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Cel.КатегСотруд fОтносКатСотр;
        
        private IIS.Cel.Стаж fКакойСтаж;
        
        private IIS.Cel.Возраст fВозрастСотруд;
        
        private string fКоммент;
        
        private IIS.Cel.Специалист fСпециалист;
        
        private IIS.Cel.DetailArrayOfОценПричУвольн fОценПричУвольн;
        ...
        public virtual IIS.Cel.Возраст ВозрастСотруд
        {
            get
            {
                ...
                IIS.Cel.Возраст result = this.fВозрастСотруд;
        ...
        public virtual IIS.Cel.Стаж КакойСтаж
        {
            get
            {
                ...
                IIS.Cel.Стаж result = this.fКакойСтаж;
        ...
        public virtual IIS.Cel.КатегСотруд ОтносКатСотр
        {
            get
            {
                ...
                IIS.Cel.КатегСотруд result = this.fОтносКатСотр;
        ...
        [PropertyStorage(new string[] {
                "Специалист"})]
        public virtual IIS.Cel.Специалист Специалист
        {
            get
            {
                ...
                IIS.Cel.Специалист result = this.fСпециалист;
        ...
        public virtual IIS.Cel.DetailArrayOfОценПричУвольн ОценПричУвольн
        {
            get
            {
                ...
                {
                    this.fОценПричУвольн = new IIS.Cel.DetailArrayOfОценПричУвольн(this);
                }
                IIS.Cel.DetailArrayOfОценПричУвольн result = this.fОценПричУвольн;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View АнкетыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АнкетыE", typeof(IIS.Cel.Анкеты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View АнкетыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АнкетыL", typeof(IIS.Cel.Анкеты));
                }
            }
        }
    }
